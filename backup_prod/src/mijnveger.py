...
class Board:
    ...
    def reveal_cell(self, row, col):
        cells_to_reveal = []  # Initialize cells_to_reveal
        ...
        if self.board[row][col].adjacent_mines == 0:
            cells_to_reveal = self.reveal_adjacent_cells(row, col)
            ...
            for dc in [-1, 0, 1]:
                ...
                if 0 <= new_row < self.size and 0 <= new_col < self.size:
                    ...
                    if not cell.is_revealed:
                        ...
                        cells_to_reveal.append((new_row, new_col))
                        if cell.adjacent_mines == 0:
                            cells_to_reveal.extend(self.reveal_adjacent_cells(new_row, new_col))
        return cells_to_reveal
